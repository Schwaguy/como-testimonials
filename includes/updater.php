<?php
/* Load Class. */
$fxupdater_comotestimonial_updater = new fxUpdater_comotestimonial_Updater();
/**
 * Updater Class
**/
class fxUpdater_comotestimonial_Updater{
	/**
	 * Class Constructor
	 */
	public function __construct() {
		...
		$this->config = array(
			...
			'type'    => 'plugin',
			'id'      => 'como-testimonials/como-testimonials.php',
			'api'     => '1.0.3',
			'post'    => array(),
		);
		/* Admin Init */
